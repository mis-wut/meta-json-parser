...
cudf::io::table_with_metadata generate_example_dataframe()
{
    ...
    column_wrapper<float>   col2{{-0.0f, 1e-5f, 1.2345f, std::numeric_limits<float>::infinity()}};
    ...
    str_col_wrapper col5{{"1.,;	|?  ",
                          "abc def ghi",
                          "\"jkl mno pqr\"",
                          "stu \"wv\" xyz"}};
    cudf::test::fixed_width_column_wrapper<cudf::duration_ns, int64_t>
        col6{{-86400L, -1L, 0L, 286134307L}};
    ...
    std::vector<std::string> column_names{"int32",
                                          "float",
                                          "bool",
                                          "timestamp[s]",
                                          "string",
